        ...
        <div class="offcanvas-body">
            ...
            <div class="dropdown mx-2 align-self-end">
                ...
                <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                    <li><a class="dropdown-item active" href="#"><i class='bx bxs-user-plus me-sm-2' ></i><span class="ms-1">Add Staff</span></a></li>
            ...
            <div class = "h-100">
                ...
                <div class="col text-center mh-50 mb-3 mx-3" style="background-image: url('<?= $hotelimg?>'); background-size:cover; background-repeat: no-repeat;">
                    <div class="px-2 pt-2 w-100 y-100 h-100 d-flex" style="background: rgb(32,32,39); background: linear-gradient(90deg, rgba(32,32,39,0.3) 0%, rgba(53,53,78, 0.3) 28%, rgba(94,94,108, 0.3) 70%, rgba(111,106,106, 0.3) 100%); backdrop-filter: blur(5px);">
                        <div class="px-2 pt-2 pt-sm-3 m-auto" style="text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.5);">
                            <div>
                                <h1 class="display-5" style="font-family: 'Staatliches';"><?= $hotelname?><br><span class="display-2" style="color:#22092C;">Manage Staff Registration</span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="staff-register-action.php" method="post">
                    <div class="mb-3">
                    ...
                    <hr>
                    <div class="mb-3">
                        <label for="firstName" class="form-label">Staff First Name :</label>
                        <input type="text" name = "firstName" class="form-control" id="userName">
                    </div>
                    <div class="mb-3">
                        <label for="lastName" class="form-label">Staff Last Name :</label>
