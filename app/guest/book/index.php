...
class Directory {
    public static function getTempDir() {
        return realpath(dirname(__FILE__) . '/../../directory.php');
    }
}

class BookPart {
    public static function load() {
        require_once Directory::getTempDir() . '/bookpart.php';
    }
}

// Use the defined classes and methods
...
<body data-bs-theme="dark">
    <!-- Navbar -->
    <?php
    require Directory::getTempDir() . "/navguest.php";
    ?>
    <!-- End Navbar -->
            ...
            <form class="row row-cols-1 g-4 pb-4" id="bookform" method="post">
                ...
                <div class="col">
                    <div class="card h-100" style="min-height: 80vh;">
                        ...
                        <div class="card-body">
                            <h2 class="card-title fw-bold" style="font-family: 'Poppins';">
                                No : <?= $roomNo ?> - <?= $roomname ?>
                            </h2>
    ...
    <!-- Footer -->
    <?php
    require Directory::getTempDir() . "/footer.php";
    ?>
