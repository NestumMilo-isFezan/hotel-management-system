        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="dropdown ms-3 mb-2 justify-content-center d-flex">
                ...
                <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                    <li><a class="dropdown-item" href="guest/profile/index.php"><i class='bx bxs-user-circle' ></i><span class="ms-1">Manage Profile</span></a></li>
                    <li><a class="dropdown-item" href="guest/guest_confirm/index.php"><i class='bx bxs-bed me-sm-2'></i></i><span class="ms-1">Manage Booking</span></a></li>
