                                ...
                                <div class="accordion-body">
                                    <div class="container-fluid w-100 h-100">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal list-group">
                                            <li class="list-group-item active"><a href="../room/index.php" class="link-body-emphasis text-decoration-none rounded mb-sm-3"><i class='bx bxs-plus-square me-sm-2 fs-4' ></i><span class="d-inline-block">Hotel Room</span></a></li>
            ...
            <div class="col text-center mh-50 mb-3 mx-3" style="background-image: url('<?= $hotelimg?>'); background-size:cover; background-repeat: no-repeat;">
                <div class="px-2 pt-2 w-100 y-100 h-100 d-flex" style="background: rgb(32,32,39); background: linear-gradient(90deg, rgba(32,32,39,0.3) 0%, rgba(53,53,78, 0.3) 28%, rgba(94,94,108, 0.3) 70%, rgba(111,106,106, 0.3) 100%); backdrop-filter: blur(5px);">
                    <div class="px-2 pt-2 pt-sm-3 m-auto" style="text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.5);">
                        <div>
                            <h1 class="display-5" style="font-family: 'Staatliches';"><?= $hotelname?><br><span class="display-2" style="color:#22092C;">Manage Hotel Room</span></h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="tablecontent" class = "mx-1 overflow-x-auto">
            <table class = "table table-hover table-bordered border-danger">
                ...
                <tbody class="table-danger table-striped">
                    ...
                    <?php if ($row["roomstatus"]=='available') : ?>
                    <td class="align-middle text-center"><span class="badge text-bg-success"><?= $row["roomstatus"]?></span></td>
                    <?php elseif($row["roomstatus"]=="unavailable") : ?>
                    <td class="align-middle text-center"><span class="badge text-bg-danger text-center"><?= $row["roomstatus"]?></span></td>
                    <?php endif; ?>

                    <td>
                        <div class="d-grid gap-2 d-block">
                        <button type="button" class="btn btn-primary btn-sm update" id="editit" data-bs-toggle="modal" data-bs-target="#formmodal" data-id="<?= $row['roomID']?>">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm update" id="deleteit" data-id="<?= $row['roomID']?>">Delete</button>
                        </div>
                    </td>
                    </tr>
                    ...
                    <?php
                        ...
                        echo '<tr><td colspan="7">No Hotel Room Data Found ❗😕</td></tr>';
                    }
                ?>
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content" method="post" id="addform">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Hotel Room</h1>
                ...
                <div class="modal-body">
                    <div class="w-100">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="room type" name="roomtype" id="roomtype" required>
                                ...
                                if ($resultRoomTypes) {
                                    while ($rowRoomType = mysqli_fetch_assoc($resultRoomTypes)) {
                                        echo '<option value="' . $rowRoomType["typeID"] . '">' . $rowRoomType["name"] . '</option>';
                                    }
                                }
                                mysqli_close($conn);
                                ?> 
                        ...
                        <div clas="mb-3">
                            ...
                            <select class="form-select" aria-label="room status" name="roomstatus" id="roomstatus">
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    ...
    <div id="deleteToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
        Successfully Delete Hotel Room
        </div>
    </div>
