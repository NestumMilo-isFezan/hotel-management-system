...
<body class="vh-100" data-bs-theme="dark">
    ...
    <div class = "container-fluid">
        <div class = "h-100">
            <!-- Header -->
            <div id="heade" class="col text-center mh-50 mb-3 mx-3" style="background-image: url('<?= $hotelimg?>'); background-size:cover; background-repeat: no-repeat;">
                <div id="headcontent" class="px-2 pt-2 w-100 y-100 h-100 d-flex" style="background: rgb(32,32,39); background: linear-gradient(90deg, rgba(32,32,39,0.3) 0%, rgba(53,53,78, 0.3) 28%, rgba(94,94,108, 0.3) 70%, rgba(111,106,106, 0.3) 100%); backdrop-filter: blur(5px);">
                    <div class="px-2 pt-2 pt-sm-3 m-auto" style="text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.5);">
                        <div>
                            <h1 class="display-5" style="font-family: 'Staatliches';"><?= $hotelname?><br><span class="display-2" style="color:#22092C;">Manage Hotel Info</span></h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid p-3 m-1">
                <ul class="nav nav-tabs w-100" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#tocheckout" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Info</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">News</button>
                    </li>
            ...
            <div class="tab-content vh-100" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="tocheckout" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                    ...
                    <div class="mx-3">
                        <div class = "container-fluid mb-4">
                            <div class="d-flex flex-column flex-sm-row justify-content-sm-between justify-content-end">
                                ...
                                <div class="">
                                    <button type="button" id="editbtn" class="btn btn-primary mt-sm-2 btn-sm">
                                        Edit Info
                                    </button>
                                </div>
                            </div>
                    ...
                    <div id="hotelcontent" class="container-fluid mx-auto mt-1 mb-5 bg-dark-subtle rounded-3">
                        <form id="infoform" class="row g-3 p-2 ">
                            <div class="col-12">
                                <input type="hidden" id="hotelid" value="<?= $hotelID?>">
                                <label for="hotelname" class="form-label">Hotel Name</label>
                                <input type="text" class="form-control" id="hotelname" value="<?= $hotelname?>">
                            </div>
                            <div class="col-md-6">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email" value="<?= $hotelemail?>">
                            </div>
                            <div class="col-md-6">
                                <label for="contact" class="form-label">Contact</label>
                                <input type="contact" class="form-control" id="contact" value="<?= $hotelcontact?>">
                            </div>
                            <div class="col-12">
                                <label for="address" class="form-label">Address</label>
                                <input type="text" class="form-control" id="address" value="<?= $haddress?>">
                            </div>
                            <div class="col-md-2">
                                <label for="postcode" class="form-label">Postcode</label>
                                <input type="text" class="form-control" id="postcode" value="<?= $hpostcode?>">
                            </div>
                            <div class="col-md-6">
                                <label for="city" class="form-label">City</label>
                                <input type="text" class="form-control" id="city" value="<?= $hcity?>">
                            </div>
                            <div class="col-md-4">
                                <label for="state" class="form-label">State</label>
                                <input type="text" class="form-control" id="state" value="<?= $hstatename?>">
                            </div>
                            <div class="col-12">
                                <label for="info" class="form-label">Info</label>
                                <textarea type="text" class="form-control" id="info"><?= $info?></textarea>
                            </div>
                            <div class="col-12">
                                <label for="about" class="form-label">About</label>
                                <textarea type="text" class="form-control" id="about"><?= $about?></textarea>
                            </div>
                            
                            <div class="col-12 d-flex justify-content-center mb-3">
                                <button id="finishbtn" type="submit" class="btn btn-primary" style="width:100px; display:none;">Finish</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                ...
                <div class="container-fluid mx-auto mt-1 mb-5 p-2 pt-3 bg-dark-subtle rounded-3">
                    <div id="newscontent" class = "mx-1 overflow-x-auto">
                        <table class = "table table-hover table-bordered border-danger" id="newstable">
                            ...
                            <tbody class="table-danger table-striped">
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm update editit" data-bs-toggle="modal" data-bs-target="#formmodal" data-id="<?= $row['newsID']?>">Edit</button>
                                    <button type="button" class="btn btn-danger btn-sm update deleteit" data-id="<?= $row['newsID']?>">Delete</button>
                                    </div>
                                </td>
                                </tr>
                                ...
                                <?php
                                    ...
                                    echo '<tr><td colspan="7">No News Data Found ❗😕</td></tr>';
                                }
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <form class="modal-content" method="post" id="addform">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Add Hotel News</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="w-100">
                                <div class="mb-1">
                                    <label for="newstitle" class="col-form-label">News Title :</label>
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <label for="description">Describe The News</label>
                                    </div>
                                </div>
                            </div>
                        </div>
