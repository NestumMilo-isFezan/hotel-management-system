...
$dummyasset = ICON_DIR . "/upload.jpg";
?>
...
<body class="vh-100" data-bs-theme="dark">
                                ...
                                <div class="accordion-body">
                                    <div class="container-fluid w-100 h-100">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal list-group">
                                            ...
                                            <li class="list-group-item active"><a href="../room-type/index.php" class="link-body-emphasis text-decoration-none rounded mb-sm-1"><i class='bx bxs-layer-plus me-sm-2 fs-4'></i><span class="d-inline-block">Room Type</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                </div>
            ...
            <div class="col text-center mh-50 mb-3 mx-3" style="background-image: url('<?= $hotelimg?>'); background-size:cover; background-repeat: no-repeat;">
                <div class="px-2 pt-2 w-100 y-100 h-100 d-flex" style="background: rgb(32,32,39); background: linear-gradient(90deg, rgba(32,32,39,0.3) 0%, rgba(53,53,78, 0.3) 28%, rgba(94,94,108, 0.3) 70%, rgba(111,106,106, 0.3) 100%); backdrop-filter: blur(5px);">
                    <div class="px-2 pt-2 pt-sm-3 m-auto" style="text-shadow: 1px 1px 1px rgba(0, 0, 0, 0.5);">
                        <div>
                            <h1 class="display-5" style="font-family: 'Staatliches';"><?= $hotelname?><br><span class="display-2" style="color:#22092C;">Manage Hotel Room Type</span></h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mx-3">
        <div class = "container-fluid mb-4">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between justify-content-end">
                ...
                <div class="">
                    <button type="button" class="btn btn-primary mt-sm-2 btn-sm addit" data-bs-toggle="modal" data-bs-target="#addform">
                        Add Room Type
                    </button>
                </div>
            </div>
        ...
        <div id="tablecontent" class = "mx-1 overflow-x-auto">
            <table id="typetable" class = "table table-hover table-bordered border-danger">
                ...
                <tbody class="table-danger table-striped">
                    ...
                    <td><?= $row["price"]?></td>
                    <td><?= $row["capacity"]?></td>
                    <td><?= $row["room_imgpath"]?></td>
                    <td>
                        <div class="d-grid gap-2 d-block">
                        <button type="button" class="btn btn-danger btn-sm update deleteit" data-id="<?= $row['typeID']?>">Delete</button>
                        </div>
                    </td>
                    </tr>
                    <?php
                        ...
                        echo '<tr><td colspan="7">No Hotel Room Type Data Found ❗😕</td></tr>';
                    }
                ?>
                </tbody>
            </table>
    ...
    <div class="modal fade" id="addform" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content" method="post" id="addform" enctype="multipart/form-data">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Hotel Room Type</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="w-100">
                        <div class="mb-1">
                            <img src="<?= $dummyasset?>" class="img-fluid frame" />
                        </div>
                        <div class="mb-1">
                            <label for="photo" class="col-form-label">Upload Photo :</label>
                            <input type="file" class="form-control" id="uploadphoto" accept=".jpg, .jpeg, .png">
                            <small class="text-muted">Max size: 488.28KB</small>
                            <hr>
                        </div>
                        <div class="mb-1 mt-1">
                            <input type="hidden" id="h_id" value="<?= $hotelID?>" >
                            <label for="roomtype" class="col-form-label">Room Type :</label>
                            <input type="text" class="form-control" id="roomtype" name="roomtype" placeholder="Eg:/ Deluxe Room">
                        </div>
                        <div class="mb-1">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" id="capacity" name="capacity" placeholder="1-4 people? Depends">
                        </div>
                        <div class="mb-3">
                            <label for="description" class="col-form-label">Description :</label>
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Describe this room" id="description" name="description" style="height: 100px;"></textarea>
                                <label for="description">Describe Room Type</label>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="editform" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content" method="post" id="addform" enctype="multipart/form-data">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Hotel Room Type</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="w-100">
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="editToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        Successfully Edit Hotel Room Type
        </div>
    </div>
    ...
    <div id="deleteToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
        Successfully Delete Hotel Room Type
        </div>
    </div>
    ...
    <div id="addToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
        Successfully Add New Type of Hotel Room
        </div>
    </div>
